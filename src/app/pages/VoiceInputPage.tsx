...
export function VoiceInputPage() {
  ...
  const handleToggleRecording = () => {
    if (isRecording) {
      ...
      // Simulamos transcripción
      setTimeout(() => {
        setTranscript('Me gustaría hacer ejercicios suaves por la mañana, leer un poco después del desayuno, y salir a caminar por la tarde.');
      }, 3000);
    }
  };
